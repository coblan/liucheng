...
class WorkGroup(models.Model):
    ...
    short_desp=models.CharField('业务类型',max_length=300)
    long_desp=models.TextField('详细描述',blank=True)
    client=models.ForeignKey('BusClient',verbose_name='客户名称',blank=True,null=True)
...
class WorkTemplate(models.Model):
    short_desp=models.CharField('业务类型',max_length=300)
    long_desp=models.TextField('详细描述',blank=True)
    content=JsonField(verbose_name='进度详情',blank=True,default=[])
